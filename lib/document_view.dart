...
class DocumentViewController {
  ...
  Future<void> removeBookmark(int page) {
    return _channel.invokeMethod(Functions.removeBookmark, <String, dynamic>{
      Parameters.title: 'Seite $page',
      Parameters.pageNumber: page,
    });
  }

  Future<String> saveDocument(String toPath) {
    return _channel.invokeMethod(
        Functions.saveDocument, <String, dynamic>{Parameters.path: toPath});
  }
  ...
  Future<void> openThumbnailBrowser() {
    return _channel.invokeMethod(Functions.openThumbnailBrowser);
  }

  Future<void> setHorizontal() {
    return _channel.invokeMethod(Functions.setHorizontal);
  }

  Future<void> setVertical() {
  ...
  Future<String> extractTextForPage(int pageNumber) {
    return _channel
        .invokeMethod(Functions.extractTextForPage, <String, dynamic>{
      Parameters.pageNumber: pageNumber,
    });
  }
}
