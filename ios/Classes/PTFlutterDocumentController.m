...
- (void)viewDidLoad
{
    ...
    self.thumbnailSliderController.slider.hidden = YES;
...
{
    [super setThumbnailSliderHidden:YES animated:NO];
    [super setControlsHidden:YES animated:NO];
    NSLog(@"Hello, World! \n");
...
- (void)applyViewerSettings
{
    ...
    self.thumbnailSliderController.toolbar.translucent = YES;
...
{
    NSLog(@"APPLIED LAYOUT MODE \n");
    NSLog(@"%@", self.layoutMode);
